...
public record DungeonStatsDto(string Name, IEnumerable<RunMember> Members, DateTime PeriodStart, DateTime PeriodEnd, int TimeSpent, int TimeGate, bool InTime, int KeyLevel, double Scroe)
{
